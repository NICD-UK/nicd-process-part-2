...
- hierarchical structure with phases, tasks and outcomes
...
were combined into the **Wrangle Data** task. These tasks were in the wrong order and the outcomes where too abstract. The **Clean Data** and **Wrangle Data** tasks each output scripts and data.
...
- both the *process review* and *project review* will help improve the workflow
- [TDSP](https://docs.microsoft.com/en-us/azure/architecture/data-science-process/lifecycle) workflow has a more refined **Business Understanding** phase with "sharp" questions and [SMART](https://en.wikipedia.org/wiki/SMART_criteria) success criteria
- TDSP also has a more modern **Data Acquisition and Understanding** phase that considers aspects of streaming vs batch, small vs big data, structured vs unstructured data etc. 
- some tasks need additional guidance (i.e. tasks in the Data Preparation and Modelling phases)
