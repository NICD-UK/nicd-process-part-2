...
- [TDSP](https://docs.microsoft.com/en-us/azure/architecture/data-science-process/lifecycle) workflow has a more refined **Business Understanding** phase with "sharp" data science questions and [SMART](https://en.wikipedia.org/wiki/SMART_criteria) success criteria
